...
namespace Substrate.Widgets
{
    public class HexView
    {
        ...
        public unsafe void Draw()
        {
            ...
            Substrate.Fonts.PushFont(FontManager.UbuntuMonoRegular, 16);
            ...
            if (ImGui.BeginTable("Hex table", 4, ImGuiTableFlags.SizingFixedFit)) {
                ...
                ImGui.TableSetupColumn("Ascii", ImGuiTableColumnFlags.WidthFixed, (ByteDisplaySize.X * 7));
                ...
                for (int i = 0; i < totalLines; i++) {
                    ImGui.TextUnformatted(AddrStrings[i]);
                }
            ...
            for (int x = 0; x < numBytes; x++) {
                ...
                if (ByteDataArr[index].HighlightIdx != ushort.MaxValue) {
                    ...
                    if (SelectedHighlight == ByteDataArr[index].HighlightIdx || HighlightsArr[ByteDataArr[index].HighlightIdx].IsSelected) {
                        ...
                        (
                            ...
                            byteWidth,
                            ImGui.ColorConvertFloat4ToU32(Substrate.Theme.HexSelectedUnderline.Primary)
                        );
                    }
                }
                ...
                if (ImGui.IsMouseHoveringRect(pos, pos + ByteDisplaySize)) {
                    ...
                    (
                        pos + new Vector2(0, 15f),
                        pos + ByteDisplaySize,
                        ImGui.ColorConvertFloat4ToU32(Substrate.Theme.HexHovered.Primary)
                    );
                ...
                ImGui.Text(LookupB         + (ByteDataArr[index].Byte * 4));
