...
namespace Substrate.Scene3D
{
    ...
    public class World
    {
        ...
        public World()
        {
            ...
            var factory = Substrate.App.GD.ResourceFactory;
            ...
            ProjViewSet      = factory.CreateResourceSet(new ResourceSetDescription(Substrate3D.GetProjViewLayout(), ViewStateBuffer));
        }
