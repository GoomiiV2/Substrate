...
namespace Substrate.Scene3D.Components
{
    public class DebugShapesComp : Component
    {
        ...
        {
            var vert      = new ShaderDescription(ShaderStages.Vertex, Resources.GetEmbeddedAsset("Assets.Shaders._3D.DebugShapes.DebugShapesVert.spirv"), "main");
            var geo       = new ShaderDescription(ShaderStages.Geometry, Resources.GetEmbeddedAsset("Assets.Shaders._3D.DebugShapes.DebugShapesGeo.spirv"), "main");
            var frag      = new ShaderDescription(ShaderStages.Fragment, Resources.GetEmbeddedAsset("Assets.Shaders._3D.DebugShapes.DebugShapesFrag.spirv"), "main");
